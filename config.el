...
(defun +user/init-cjk-fonts ()
  ...
  (dolist (script '(hangul han kana))
    (set-fontset-font t script "Noto Sans CJK KR")))
(add-hook 'after-setting-font-hook #'+user/init-cjk-fonts)
...
(setq org-directory "~/.dotfiles/private/org/")
